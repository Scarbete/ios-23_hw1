...
class ViewController: UIViewController {
    ...
    private func validateTF(tf: UITextField, placeholder: String, error: String, label: UILabel, view: UIView) {
        if tf.hasText {
    ...
    @objc func signInButtonTapped(_ sender: UIButton) {
        let vc = SuccessVC()
        validateTF(tf: emailTF, placeholder: "Employee Id / Email", error: "Fill the text", label: emailLabel, view: emailBottomView)
        validateTF(tf: passwordTF, placeholder: "Password", error: "Fill text or less then 3", label: passwordLabel, view: passwordBottomView)
